...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("bg-card text-card-foreground gap-6 overflow-hidden rounded-lg border border-border py-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 group/card flex flex-col", className)}
      {...props}
    />
  )
}
